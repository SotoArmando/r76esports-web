...
final List<int> unicodeCodePoints =
    List.generate(0x1F9CF - 0x1F600 + 1, (i) => 0x1F600 + i);
final lerped_black_02 =
    lerped_black_0(const Color.fromRGBO(0, 170, 255, 1), 0.97);
final lerped_black_03 =
    lerped_black_0(const Color.fromARGB(255, 208, 0, 255), 0.025);
...
LinearGradient lerped_black_0(Color color, double double) => LinearGradient(
        ...
        colors: [
          Color.lerp(const Color.fromARGB(255, 18, 14, 1), color, double)!,
          Color.lerp(const Color.fromARGB(255, 51, 68, 58), color, double)!,
          Color.lerp(const Color.fromARGB(255, 41, 53, 53), color, double)!,
        ],
        stops: const [
          0,
          0.58,
...
LinearGradient lerped_black_1(Color color, double double,
    ...
    LinearGradient(
        ...
        colors: colors != null
            ...
            : [
                Color.lerp(
                    const Color.fromARGB(255, 18, 14, 1), color, double)!,
                Color.lerp(
                    const Color.fromARGB(255, 51, 68, 58), color, double)!,
                Color.lerp(
                    const Color.fromARGB(255, 41, 53, 53), color, double)!,
              ],
