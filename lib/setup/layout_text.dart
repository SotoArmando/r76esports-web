...
double Function(TextSpan text, double maxHeight, double maxWidth)
  ...
  // print("${text.text} $maxHeight ${multilineTextPainter.height} $maxWidth");
  // print("${maxHeight < multilineTextPainter.height}");

  if (maxHeight < multilineTextPainter.height) {
    return nextSpan.style!.fontSize!;
  } else {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (renderedResults == null) {
          // print(
          //     "\nbegin returnBoundedProportion(textWidget, constraints) ${text.replaceAll("\n", " ")}");
          // print(constraints.maxHeight);
          // print(constraints.maxWidth);
          renderedResults = returnBoundedProportion(textWidget, constraints);
          // print(
          //     "end --returnBoundedProportion(textWidget, constraints) ${text.replaceAll("\n", " ")}\n\n");
