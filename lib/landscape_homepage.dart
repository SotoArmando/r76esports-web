...
import 'package:sr_flutter/customlistview.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ColoredBox(
        ...
        child: ScrollAnimator(
          ...
          builder: (context, controller, phyiscs) =>
              LazyLoadDifferentComponents(
                  // itemExtent: 1000,
                  scrollController: controller,
                  physics: phyiscs ?? const AlwaysScrollableScrollPhysics(),
                  diameter: diameter,
                  orientation: LayoutOrientation.vertical,
                  children: [
                PreferredSize(
                    preferredSize:
                        Size.fromHeight(screenWidth * 0.04399789584429248),
                    child: antiwhite),
                const {882: Landing()},
                {
