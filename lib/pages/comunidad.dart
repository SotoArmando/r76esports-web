                                                              ...
                                                              child:
                                                                  OrientedLayout(
                                                                      ...
                                                                      children: [
                                                                        {
                                                                          418.7699890136719:
                                                                              Image.asset('assets/R76/game #1.png')
                                                                        },
                                                                        {
                                                                          418.7699890136719:
                                                                              Image.asset('assets/R76/game #2.png')
                                                                        },
                                                                        {
                                                                          418.7699890136719:
                                                                              Image.asset('assets/R76/game #3.png')
                                                                        },
                                                                        {
                                                                          418.7699890136719:
                                                                              Image.asset('assets/R76/game #4.png')
                                                                        },
                                                                        {
                                                                          418.7699890136719:
                                                                              Image.asset('assets/R76/game #1.png')
                                                                    ...
                                                                    children: [
                                                                      {
                                                                        76.55999755859375: OrientedLayout(
                                                                            ...
                                                                            itemSpacing:
                                                                                0,
                                                                            children: [
                                                                              LayoutText('SK Square', style: GoogleFonts.inter(color: Colors.white))
                                                                            ])
                                                                      },
                                                                      {
                                                                        153.69000244140625: OrientedLayout(
                                                                            ...
                                                                            itemSpacing:
                                                                                0,
                                                                            children: [
                                                                              LayoutText('Comcast Spectacor', style: GoogleFonts.inter(color: Colors.white))
                                                                            ])
                                                                      }
                                                                    ]))
                                                  },
